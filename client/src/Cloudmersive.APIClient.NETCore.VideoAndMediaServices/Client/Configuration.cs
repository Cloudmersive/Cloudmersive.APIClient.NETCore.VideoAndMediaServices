...
namespace Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/2.0.4/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/2.0.4/csharp"
        ...
        {
            String report = "C# SDK (Cloudmersive.APIClient.NETCore.VideoAndMediaServices) Debug Report:\n";
            report += "    OS: " + System.Runtime.InteropServices.RuntimeInformation.OSDescription + "\n";
            report += "    Version of the API: v1\n";
            report += "    SDK Package Version: 2.0.4\n";
