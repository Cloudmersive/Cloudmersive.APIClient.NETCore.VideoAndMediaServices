...
namespace Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Api
{
    /// <summary>
    ...
    public interface IAudioApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = new Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.Configuration { BasePath = basePath };

            ExceptionFactory = Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public AudioApi(Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.Configuration configuration = null)
        {
            if (configuration == null) // use the default one in Configuration
                this.Configuration = Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.Configuration.Default;
            else
        ...
        public Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.Configuration Configuration {get; set;}

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Cloudmersive.APIClient.NETCore.VideoAndMediaServices.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
